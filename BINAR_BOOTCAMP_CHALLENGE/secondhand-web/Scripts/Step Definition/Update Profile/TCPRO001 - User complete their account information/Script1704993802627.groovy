...
WebUI.click(findTestObject('Profile Page/Alamat_input'))

WebUI.sendKeys(findTestObject('Profile Page/Alamat_input'), 'Jalan-in aja dulu')

WebUI.sendKeys(findTestObject('Profile Page/No Handphone_input'), '0812345678')
