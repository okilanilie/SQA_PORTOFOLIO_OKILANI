...
WebUI.sendKeys(findTestObject('Profile Page/Nama_input'), nama)

WebUI.selectOptionByValue(findTestObject('Profile Page/Kota_dropdown'), '', true)

WebUI.sendKeys(findTestObject('Profile Page/Alamat_input'), alamat)

WebUI.sendKeys(findTestObject('Profile Page/No Handphone_input'), nohandphone)
